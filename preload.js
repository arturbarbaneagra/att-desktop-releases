...
try {
  contextBridge.exposeInMainWorld('attTrade', {
    ...
    caps: ['acct:bybit', 'acct:phemex', 'acct:binance', 'acct:okx', 'acct:gate', 'acct:bitget', 'acct:mexc', 'acct:kucoin', 'acct:bitmex', 'acct:kraken', 'acct:asterdex', 'cat:phemex', 'cat:kucoin', 'cat:gate', 'cat:bitmex', 'cat:kraken', 'cat:mexc', 'cat:mexc2', 'cat:arcus', 'cat:http', 'lblot:binance', 'lblot:kraken', 'lblot:hyperliquid', 'lblot:bybit', 'lblot:gate', 'lblot:bitget', 'lblotri'],
  });
